...
int main(int argc, char* argv[]){
  ...
  // internal (self) collisions do happen. 
    std::vector<double> joint_values{0.0,0.0,0.0,-2.0,0.0,1.4,0.0};
    ...
    // have happened at a given configuration of the Panda arm.
    ...
    // all collisions between the links reported above
